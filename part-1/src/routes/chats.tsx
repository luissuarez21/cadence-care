...
function ChatsPage() {
  return (
    <PatientShell eyebrow="Your conversations" title="All chats">
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[13px] text-white/85 truncate">Tap to continue your check-in chat</p>
        </div>
