...
import type { PastMsg } from "@/lib/pastChats";
...
export function PastChatView({ title, messages }: { title: string; messages: PastMsg[] }) {
  return (
...
function AllChatsLink() {
  return (
    <Link
      to="/chats"
      className="inline-flex items-center gap-1.5 text-[13px] font-medium text-leaf-700 hover:text-bloom-600 transition-colors mb-4 -ml-0.5"
    >
